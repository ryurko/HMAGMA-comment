...
resampled_data <- as.matrix(
  data.table::fread(
      "/home/ryurko/asd_gene_analysis/combine_snps_sims/resampled_genotypes/ex_gene51306_chr5_nsnps24_genotype.csv"))
  ...
  mclapply(1:25, mc.cores = 25,
           FUN = function(i) {
             ...
             write_csv(as.data.frame(null_sims_results),
                       paste0(
                         "/home/ryurko/asd_gene_analysis/combine_snps_sims/update_resampled_sims/more_null/gene51306_1/null_sim_",
                         i, ".csv"))
...
sim_list <-
  mclapply(1:25, mc.cores = 25,
           FUN = function(i) {
             ...
             write_csv(as.data.frame(null_sims_results),
                       paste0(
                         "/home/ryurko/asd_gene_analysis/combine_snps_sims/update_resampled_sims/more_null/gene51306_2/null_sim_",
                         i, ".csv"))
...
sim_list <-
  mclapply(1:25, mc.cores = 25,
           FUN = function(i) {
             ...
             write_csv(as.data.frame(null_sims_results),
                       paste0(
                         "/home/ryurko/asd_gene_analysis/combine_snps_sims/update_resampled_sims/more_null/gene51306_3/null_sim_",
                         i, ".csv"))
