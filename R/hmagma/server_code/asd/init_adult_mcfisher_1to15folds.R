...
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_1.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_2.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_3.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_4.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_5.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_6.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_7.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_8.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_9.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_10.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_11.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_12.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_13.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_14.csv")
...
tidy_group_pval_summary <-
  ...
  bind_rows()
write_csv(tidy_group_pval_summary,
          "/home/ryurko/asd_genome_wide_analysis/hmagma/data/output/asd/adult/tidy_gene_pval_summary_15.csv")
